...
#
# Script generated by Vivado on Sun Sep 07 12:34:14 +0530 2025
...
# script info
echo -e "output_buffer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot output_buffer xil_defaultlib.output_buffer xil_defaultlib.glbl -log elaborate.log
}
