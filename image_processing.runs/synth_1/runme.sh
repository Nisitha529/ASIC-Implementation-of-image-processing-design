...
HD_PWD='/media/nisitha/My_Passport/image_processing/image_processing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_sobel_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_sobel_top.tcl
